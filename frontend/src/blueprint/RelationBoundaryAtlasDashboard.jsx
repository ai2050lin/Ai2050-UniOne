...
import samplePayload from './data/relation_boundary_atlas_sample.json';
...
export default function RelationBoundaryAtlasDashboard() {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
        <div>
          <div style={{ color: '#e2e8f0', fontSize: '15px', fontWeight: 'bold' }}>关系族边界类型图谱</div>
          <div style={{ color: '#94a3b8', fontSize: '11px', lineHeight: '1.7', marginTop: '4px' }}>
            把六类关系协议分成“紧致边界”“仅层簇边界”“分布式无边界”三类，直接比较不同模型在关系协议实现形态上的差别。
          </div>
        </div>
