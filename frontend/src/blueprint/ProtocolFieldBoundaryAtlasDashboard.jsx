...
import samplePayload from './data/protocol_field_boundary_atlas_sample.json';
...
export default function ProtocolFieldBoundaryAtlasDashboard() {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
        <div>
          <div style={{ color: '#e2e8f0', fontSize: '15px', fontWeight: 'bold' }}>协议场边界图谱</div>
