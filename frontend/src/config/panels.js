...
export const STRUCTURE_TABS_V2 = {
  groups: [
    ...
    },
    {
      ...
      items: [
        { id: 'agi', label: '神经网络 (AGI)', desc: '神经纤维丛AGI', icon: 'Brain' },
    ...
    },
    {
      ...
      icon: 'Zap',
      color: '#fbbf24',
      description: 'AGI三大终极破局拼图',
      items: [
        { id: 'gamma_sync', label: 'Gamma同步', desc: '强锁波破解绑定组', icon: 'Waves' },
        { id: 'hippo_replay', label: '海马体固化', desc: '双脑脱机重放机制', icon: 'Moon' },
        { id: 'predictive_coding', label: '主动预测', desc: '自顶向下惊奇发生器', icon: 'Eye' }
      ]
    }
  ]
};
...
export const STRUCTURE_TABS = {
  ...
  agi_core: STRUCTURE_TABS_V2.groups.find(g => g.id === 'agi_core').items,
};
...
export const ANALYSIS_DATA_TEMPLATES = {
  ...
  tda: {
    ...
    color: '#e056fd',
    metrics: [
      { key: 'betti_0', label: 'β0 连通分量', format: 'number' },
      { key: 'betti_1', label: 'β1 环', format: 'number' },
      { key: 'betti_2', label: 'β2 空腔', format: 'number' },
    ],
    sections: []
  },
  rpt: {
