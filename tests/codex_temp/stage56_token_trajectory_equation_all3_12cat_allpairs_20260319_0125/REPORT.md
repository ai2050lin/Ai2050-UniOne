...
- Qwen/Qwen3-4B
  ...
  - syntax: hidden=tail_pos_-4, mlp=tail_pos_-4, layer=layer_34, head=layer_4_head_8
...
- zai-org/GLM-4-9B-Chat-HF
  - logic: hidden=tail_pos_-7, mlp=tail_pos_-7, layer=layer_39, head=layer_8_head_2
  - style: hidden=tail_pos_-7, mlp=tail_pos_-7, layer=layer_39, head=layer_39_head_30
...
## axis_stage6_link
- style: hidden->proto=0.0000, hidden->synergy=0.0000, mlp->synergy=0.0000, hidden_late->synergy=0.0000
- logic: hidden->proto=0.0000, hidden->synergy=0.0000, mlp->synergy=0.0000, hidden_late->synergy=0.0000
- syntax: hidden->proto=0.0000, hidden->synergy=0.0000, mlp->synergy=0.0000, hidden_late->synergy=0.0000
