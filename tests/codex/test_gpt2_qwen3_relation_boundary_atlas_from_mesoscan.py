#!/usr/bin/env python
"""
Condense the relation meso-field k-scan into a boundary atlas.
...
def load_mesoscan() -> dict:
    path = Path("tests/codex_temp/gpt2_qwen3_relation_protocol_mesofield_scale_20260308.json")
...
def main() -> None:
    ...
    ap.add_argument(
        "--json-out",
        type=str,
        default="tests/codex_temp/gpt2_qwen3_relation_boundary_atlas_20260308.json",
    )
    args = ap.parse_args()
    ...
    results = {
        "meta": {
            ...
            "source_json": "tests/codex_temp/gpt2_qwen3_relation_protocol_mesofield_scale_20260308.json",
        },
        "models": {},
    }
