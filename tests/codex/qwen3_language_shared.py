...
def capture_qwen_mlp_payloads(
    ...
    for layer_idx, payload_kind in layer_payload_map.items():
        ...
        if payload_kind == "neuron_in":
            ...
            handles.append(layer.mlp.down_proj.register_forward_pre_hook(make_pre_hook(layer_idx)))
            ...
            handles.append(layer.mlp.down_proj.register_forward_hook(make_post_hook(layer_idx)))
        else:
