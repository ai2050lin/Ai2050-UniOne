#!/usr/bin/env python
"""
Estimate the minimal causal scale of the relation protocol meso-field in GPT-2 and Qwen3.
...
def main() -> None:
    ...
    ap.add_argument(
        "--json-out",
        type=str,
        default="tests/codex_temp/gpt2_qwen3_relation_protocol_mesofield_scale_20260308.json",
    )
    args = ap.parse_args()
