...
from stage56_sample_regression_suite import build_suite


def test_build_suite_wraps_three_major_blocks() -> None:
    pair_density_rows = [
        {
            "model_id": "m",
            "category": "fruit",
    ...
    out = build_suite(pair_density_rows, complete_rows)
    assert out["record_type"] == "stage56_sample_regression_suite_summary"
    assert out["design_row_count"] == 1
