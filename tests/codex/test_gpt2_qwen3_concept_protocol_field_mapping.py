...
def main() -> None:
    ap = argparse.ArgumentParser(description="Map concept-to-protocol-field usage U(c,tau,l,h)")
    ...
    ap.add_argument(
        "--json-out",
        type=str,
        default="tests/codex_temp/gpt2_qwen3_concept_protocol_field_mapping_20260308.json",
    )
    args = ap.parse_args()
